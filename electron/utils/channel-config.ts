...
// schema validation errors.  OpenX falls back to DEFAULT_ACCOUNT_ID
...
// but whose account payload contains nested strict-schema objects that OpenX
...
function sanitizeDiscordGuildChannelConfig(channelConfig: unknown): void {
    ...
    // Backward compatibility for the older OpenX-generated shape:
...
export async function saveChannelConfig(
    ...
    await mutateOpenClawConfig(async (snapshot) => {
        ...
        // but OpenX still keeps channels.<id> as the local account-list source.
        ...
        // while preserving channels.<id> for OpenX's account list UI.
