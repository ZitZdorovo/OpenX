 ...
 * "openrouter.ai" carries the OpenX app-attribution headers.
 *
...
(function () {
  ...
  if (globalThis.__openxFetchPatched) return;
  globalThis.__openxFetchPatched = true;

  globalThis.fetch = function openxFetch(input, init) {
    var url =
