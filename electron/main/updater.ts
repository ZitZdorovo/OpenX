 ...
 *
 * Update providers are configured in electron-builder.yml. OpenX deliberately
 * uses its own release channel and never consumes upstream OpenX builds.
 */
...
export class AppUpdater extends EventEmitter {
  ...
  constructor() {
    ...
    logger.info(`[Updater] OpenX version: ${version}, channel: ${channel}`);
   ...
   *
   * OpenX uses a prompt-first update flow: finding an update shows a UI prompt,
