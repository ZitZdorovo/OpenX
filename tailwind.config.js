 ...
 *      stack for technical content. The legacy `serif` token aliases the UI
 *      stack so older components cannot introduce a third family.
 *
...
module.exports = {
  ...
  theme: {
    ...
    extend: {
       ...
       *
       *   - serif : compatibility alias for the same UI sans stack. Keeping
       *             the token avoids a risky mechanical rewrite while still
       *             guaranteeing that the renderer uses only two families.
       *
