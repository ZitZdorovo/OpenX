...
const PROVIDER_ID = 'openx-openai-image';
...
function buildProvider() {
  return createOpenAiCompatibleImageGenerationProvider({
    ...
    response: {
      ...
      fileNamePrefix: 'openx-image',
      sniffMimeType: true,
    },
    missingApiKeyError: 'OpenX OpenAI image API key missing',
    failureLabels: {
      generate: 'OpenX OpenAI image generation failed',
      edit: 'OpenX OpenAI image editing failed',
    },
  });
}
...
export const pluginEntry = definePluginEntry({
  id: PROVIDER_ID,
  name: 'OpenX OpenAI Image',
  description: 'Independent OpenAI-compatible image generation provider managed by OpenX.',
  register(api) {
