#!/usr/bin/env node
/**
 * Generates extension bridge files based on openx-extensions.json and
...
const MANIFEST_PATH = resolve(ROOT, 'openx-extensions.json');
...
function generateMainBridge(manifest) {
  ...
  if (installedExts.length === 0) {
    return [
      ...
      '// To add extensions, configure openx-extensions.json and link the package.',
