 ...
 * shows a misleading "app cannot be closed" dialog even when OpenX is not running.
 */
...
const PATCH_MARKER = 'OpenX-patched: skip legacy uninstaller';

const SKIP_LEGACY_UNINSTALLER = [
  '  ; OpenX-patched: skip legacy uninstaller on upgrades.',
