...
export interface ChatSession {
  ...
  /** Exact model-specific Thinking profile advertised by the remote Gateway. */
  thinkingLevels?: SessionThinkingLevel[];
  /** Legacy Gateway labels retained for compatibility with older servers. */
...
export interface ChatState {
  ...
  setSessionWorkspace: (key: string, workspacePath: string) => void;
