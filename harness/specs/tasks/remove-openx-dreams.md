---
id: remove-openx-dreams
title: Remove the OpenX Dreams integration
scenario: gateway-backend-communication
taskType: runtime-bridge
intent: Remove the developer-only OpenX Dreams page and its dedicated Control UI view while preserving generic Gateway communication, memory capability diagnostics, and existing OpenClaw dreaming configuration and data.
touchedAreas:
  - harness/specs/tasks/remove-openx-dreams.md
...
acceptance:
  - No OpenX production source, route, navigation item, locale namespace, or dedicated Control UI parameter exposes Dreams.
  ...
  - README and harness guidance no longer describe the removed OpenX Dreams page or its tests.
docs:
  required: true
---

Use this task spec when removing or auditing the OpenX-owned Dreams UI and its dedicated renderer/Main bridge.
