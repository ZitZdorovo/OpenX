...
intent: Add a bounded redacted diagnostics trace for ACP bridge events and renderer image-projection decisions so OpenX can diagnose ACP image rendering failures without modifying OpenClaw.
touchedAreas:
