...
- Treat agent-produced HTML as untrusted. Keep one dedicated-session webview with no preload, Node integration, plugins, insecure content, popup capability, or OpenX bridge; require sandboxing, context isolation, and web security.
