...
describe('workspace context helpers', () => {
  it('recognizes default workspace spellings', () => {
    ...
    expect(isDefaultWorkspacePath('/Users/alex/workspace/OpenX')).toBe(false);
  });
  ...
  it('formats labels for default and non-default workspaces', () => {
    ...
    expect(getWorkspaceDisplayLabel('/Users/alex/workspace/OpenX', '默认工作空间')).toBe('OpenX');
    expect(getWorkspaceDisplayLabel(
      '/Users/alex/workspace/OpenX',
      '默认工作空间',
      { '/Users/alex/workspace/OpenX': '我的项目' },
    )).toBe('我的项目');
