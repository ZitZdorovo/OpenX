...
export function AcpToolCallsGroup({
  ...
  if (!expanded) {
    return (
      <button
        ...
        title={toggleLabel}
        className="group flex w-full items-center gap-2 rounded-lg border border-black/[0.06] bg-black/[0.018] px-2.5 py-1.5 text-left text-xs text-muted-foreground transition-colors hover:bg-black/[0.045] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 dark:border-white/[0.08] dark:bg-white/[0.025] dark:hover:bg-white/[0.06]"
      >
  ...
  return (
    <div data-testid="acp-tool-calls-group" data-collapsed="false" className="flex w-full flex-col gap-0 rounded-xl border border-black/[0.06] bg-black/[0.018] p-1.5 dark:border-white/[0.08] dark:bg-white/[0.025]">
      <button
        type="button"
