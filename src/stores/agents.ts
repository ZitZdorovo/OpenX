...
interface AgentsState {
  ...
  getAgentPersonality: (agentId: string) => Promise<string>;
  updateAgentPersonality: (agentId: string, content: string) => Promise<string>;
...
export const useAgentsStore = create<AgentsState>((set) => ({
  ...
  getAgentPersonality: async (agentId: string) => {
    const result = await hostApi.agents.personality(agentId);
    return result.content;
  },

  updateAgentPersonality: async (agentId: string, content: string) => {
    const result = await hostApi.agents.updatePersonality(agentId, content);
    return result.content;
  },
